...
const links = [
  {
    ...
    subtitle: 'ПІБ, нік, дата народження і т.п.',
    link: '/profile/info'
  },
  {
    id: 2,
    ...
    subtitle: 'Email, телефон, місто і т.п',
  ...
  },
  {
    ...
    subtitle: 'Посилання та статистика',
    link: '/profile/link'
  },
  {
    id: 4,
    ...
    subtitle: 'Тематика блогу, напрямки і т.п',
    link: '/profile/category'
  },
  {
    id: 5,
    icon: DocIcon,
    title: 'Документи та акредитація',
    subtitle: 'Псвідчення, департаменти',
    link: '/profile/doc'
  },
  {
    id: 6,
...
<template>
  <div class="w-full relative z-1 flex flex-col items-start justify-center py-11 px-[16.3rem] max-sm:px-4 gap-5">
    <div v-if="activePage === 0" class="flex items-start flex-col gap-5 w-full">
      <div
